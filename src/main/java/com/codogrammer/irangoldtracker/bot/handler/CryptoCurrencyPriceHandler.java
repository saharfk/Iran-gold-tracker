...
@Service
@Slf4j
public class CryptoCurrencyPriceHandler {
    private final TelegramMessageSender sender;
    private final MarketPriceCache marketPriceCache;

    public CryptoCurrencyPriceHandler(TelegramMessageSender sender, MarketPriceCache MarketPriceCache) {
        this.sender = sender;
    ...
    public void handle(Update update) {
        ...
        try {
            ...
            log.error("Failed to fetch gold cryptoCurrency for chat {}", chatId, e);
            sender.send(
                    chatId,
